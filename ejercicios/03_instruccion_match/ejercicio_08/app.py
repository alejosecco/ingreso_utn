    ...
    def btn_informar_on_click(self):
        ...
        match(destino):
            case 'Bariloche' | 'Ushuaia':
                alert(title="nose", message="En este destino hace frio la mayoria de las estaciones del año")
            case  'Mar del plata' | 'Cataratas':
                alert(title="nose", message="En este destino hace calor la mayoria de las estaciones del año")
