...
class App(customtkinter.CTk):
    ...
    def btn_informar_on_click(self):
        ...
        match(mes):
            case "Enero":
                alert(title="nose", message="que comiences bien el año!!!")
            case "Marzo":
                alert(title="nose", message="a clases!!")
            case "Julio":
                alert(title="nose", message="se vienen las vacaciones!!")
            case "Diciembre":
                alert(title="nose", message="Felices fiestas!!!")
