...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        pasaje__centigrados_fahrenheit = (temperatura_centigrados * 9/5) + 32
        mensaje = "{0}°Centigrados es igual a {1}°Fahrenheit".format(temperatura_centigrados, pasaje__centigrados_fahrenheit)
        alert(title="centigrados a fahrenheit", message= mensaje)
    def btn_convertir_f_c_on_click(self):
        temperatura_fahrenheit = float(self.txt_temperatura_f.get())
        pasaje_f_c = (temperatura_fahrenheit - 32) * 5/9
        mensaje = "{0}°Fahrenheit es igual a {1}°Centigrados".format(temperatura_fahrenheit, pasaje_f_c)
        alert(title="fahrenheit a centigrados", message= mensaje)
